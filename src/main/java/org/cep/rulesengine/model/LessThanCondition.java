...
/**
 * A LessThanCondition object represents a rule condition of the
 ...
 * @author A. Rodriguez
 */
public class LessThanCondition extends RuleCondition {
     ...
     */
    public LessThanCondition(String name, String value) {
        super(name, value);
    }

    /**
     * Creates a new, empty LessThanCondition.
     */
     ...
     * is less than the <tt>value</tt> in this condition.
     *
    ...
    /**
     * Returns the String representation of a LessThanCondition.
     */
