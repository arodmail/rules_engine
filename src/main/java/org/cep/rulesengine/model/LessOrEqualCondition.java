...
/**
 * A LessOrEqualCondition object represents a rule condition of the
 ...
 * equality or inferiority. The mapping of a syntax to a Comparable is provided
 * by a ComparableFactory.
 *
 * @author A. Rodriguez
 */
public class LessOrEqualCondition extends RuleCondition {

    /**
     * Constructs an LessOrEqualCondition to test if the property named by
     * <tt>name</tt> is less than or equal to the value in <tt>value</tt>.
     */
    public LessOrEqualCondition(String name, String value) {
        super(name, value);
    }

    /**
     * Creates a new, empty LessOrEqualCondition.
     */
     ...
     * is less or equal to the <tt>value</tt> in this condition.
     *
    ...
    /**
     * Returns the String representation of a LessOrEqualCondition.
     */
