...
/**
 * A GreaterOrEqualCondition object represents a rule condition of the
 ...
 * @author A. Rodriguez
 */
public class GreaterOrEqualCondition extends RuleCondition {

    /**
     * Constructs an GreaterOrEqualCondition to test if the property named by
     * <tt>name</tt> is greater than or equal to the value in <tt>value</tt>.
     */
    public GreaterOrEqualCondition(String name, String value) {
        super(name, value);
    }

    /**
     * Creates a new, empty GreaterOrEqualCondition.
     */
     ...
     * is greater or equal to the <tt>value</tt> in this expression.
     *
    ...
    /**
     * Returns the String representation of a GreaterOrEqualExpression.
     */
